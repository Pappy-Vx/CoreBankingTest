            ...
            modelBuilder.Entity("CoreBankingTest.Core.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateOpened = new DateTime(2025, 10, 10, 8, 13, 22, 662, DateTimeKind.Utc).AddTicks(2311),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("CoreBankingTest.Core.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CustomerId = new Guid("a1b2c3d4-1234-5678-9abc-123456789abc"),
                            DateCreated = new DateTime(2025, 9, 30, 8, 13, 22, 662, DateTimeKind.Utc).AddTicks(2276),

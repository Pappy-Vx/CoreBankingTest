...
using CoreBankingTest.Application.Customers.Commands.CreateCustomer;
using CoreBankingTest.Application.Customers.Queries.GetCustomerDetails;
using CoreBankingTest.Application.Customers.Queries.GetCustomers;
using MediatR;
